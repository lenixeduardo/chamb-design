...
Charm-Design comes with powerful features to accelerate your design workflow:

### **AI-Powered Design Chat**
Describe what you want, and the AI agent edits your document through validated operations—never raw code. Every change is undo-able and reviewable.

### **23+ Pre-built Blocks**
Buttons, cards, heroes, pricing tables, forms, navigation, and more—all registered through the public plugin API.

### **Design System & Tokens**
Define colors, spacing, and typography once as tokens. Every design uses them, making rethemes instant and exported code maintainable.
...
- HTML (standalone)
- Solid.js (via plugin)
- Remotion (video, via plugin)

All exports produce clean, semantic code—no magic classNames, no editor artifacts.

### **Responsive by Default**
Edit across breakpoints (base, md, lg, xl) and your exports include proper media queries or framework equivalents.

### **Pre-built Templates**
Quick-start from 7 templates with smart block matching and AI-generated hero sections via 21st.dev:

<details open>
<summary><b>Template Gallery</b></summary>

#### SaaS Template
![SaaS](docs/screenshots/templates/saas.png)
_Full SaaS landing with navbar, hero, pricing, FAQ and more_

#### Landing Page Template
![Landing](docs/screenshots/templates/landing.png)
_Marketing-focused landing with hero, features, testimonials, and CTA_

#### Agency Template
![Agency](docs/screenshots/templates/agency.png)
_Portfolio and services showcase with team and case studies_

#### E-commerce Store Template
![Store](docs/screenshots/templates/store.png)
_Product showcase with hero, featured items, and pricing_

#### Portfolio Template
![Portfolio](docs/screenshots/templates/portfolio.png)
_Personal or professional work showcase_

#### Dashboard/App Template
![App](docs/screenshots/templates/app.png)
_Admin dashboard with sidebar, charts, and data tables_

#### Waitlist Template
![Waitlist](docs/screenshots/templates/waitlist.png)
_Email capture landing with minimal design_

#### SaaS with AI Hero (21st.dev)
![SaaS Hero](docs/screenshots/templates/saas-hero-21st.png)
_Hero section generated by AI via 21st.dev MCP integration_
